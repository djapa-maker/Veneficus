...
void afficherPerso(perso p, SDL_Surface *ecran, int ts, int v, Input I)
{
    ...
    TTF_Init();
    /*persostop*/
    if ((p.direction == 0) && (p.X == 0) && (I.fight == 0) && (v != p.numvie - 1)) //stop
    {
        SDL_BlitSurface(p.tab1[1], NULL, ecran, &p.poshero);
    }

    else if ((p.direction == 1) && (p.X == 0) && (I.fight == 0) && (v != p.numvie - 1)) //stop1
    {
    ...
    else if ((p.direction == 0) && (v == p.numvie - 1) && (p.X == 0)) //mort0
    {
    ...
    else if ((p.direction == 0) && (v != p.numvie) && (I.jump == 1) && (p.X != 0) && (p.Y != 0)) // saut0up
    {
        SDL_Delay(200);
        SDL_BlitSurface(p.tab7[p.frame6], NULL, ecran, &p.poshero);
    }

    else if ((p.direction == 1) && (v != p.numvie) && (I.jump == 1) && (p.X != 0) && (p.Y != 0)) //saut1up
    {
        SDL_Delay(200);
...
void animerperso(perso *p, SDL_Surface *ecran, int v, Input *I)
{
    ...
    else if ((p->direction == 0) && (v != p->numvie) && (I->jump == 1) && (p->X != 0) && (p->Y != 0)) // saut0
    {
    ...
    else if ((p->direction == 1) && (v != p->numvie) && (I->jump == 1) && (p->X != 0) && (p->Y != 0)) //saut1
    {
        SDL_Delay(100);
