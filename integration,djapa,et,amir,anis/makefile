travail:background.o main.o fonction.o hero.o enigmealeatoire.o
	gcc background.o main.o fonction.o hero.o enigmealeatoire.o -o travail -lSDL -lSDL_mixer -lSDL_image -lSDL_ttf -g
main.o:main.c	
