...
void affichage(int interface, int y, int f, int k, menu m, SDL_Surface *ecran, int n)
{
  ...
  else if (interface == 1)
  {
    ...
    else if (y == 2) // son
    {
      ...
      case 1: // affichage fullscreen
            ...
            //m.ecran = SDL_SetVideoMode(1399, 787, 32, SDL_HWSURFACE| SDL_DOUBLEBUF | SDL_RESIZABLE | SDL_FULLSCREEN);
      ...
      case 2:
          ...
          m.ecran = SDL_SetVideoMode(1399, 787, 32, SDL_HWSURFACE| SDL_DOUBLEBUF | SDL_RESIZABLE | SDL_FULLSCREEN);
         //m.ecran= SDL_SetVideoMode(800,600,32,SDL_HWSURFACE | SDL_DOUBLEBUF | SDL_RESIZABLE | SDL_FULLSCREEN);        
       // SDL_BlitSurface(m.imgfullscreen, NULL, m.ecran, &m.posfullscreen);
       // SDL_BlitSurface(m.imgnormalscreen2, NULL, m.ecran, &m.posnormalscreen);
        break;
      }
  ...
  else if (interface == 2)
  {
    ...
    if (y == 0)   //0 bouton active
    {
      ...
      SDL_BlitSurface(m.imgnewgame, NULL, m.ecran, &m.posnewgame); //new game Normal
      SDL_BlitSurface(m.imgloadgame, NULL, m.ecran, &m.posloadgame); //load game Normal
      SDL_BlitSurface(m.imgmultijoueur, NULL, m.ecran, &m.posmultijoueur); //multijoueurs Normal
    }
    else if (y == 1) //new game
    {
      
      SDL_BlitSurface(m.imgnewgame2, NULL, m.ecran, &m.posnewgame); //new game bleu
      SDL_BlitSurface(m.imgloadgame, NULL, m.ecran, &m.posloadgame); //load game Normal
      SDL_BlitSurface(m.imgmultijoueur, NULL, m.ecran, &m.posmultijoueur); //multijoueurs NaNormal
      Mix_PlayChannel(0, m.son, 0);
    }
    else if (y == 2)  //load game
    {
      ...
      SDL_BlitSurface(m.imgnewgame, NULL, m.ecran, &m.posnewgame);
      SDL_BlitSurface(m.imgloadgame2, NULL, m.ecran, &m.posloadgame);
      SDL_BlitSurface(m.imgmultijoueur, NULL, m.ecran, &m.posmultijoueur);
      Mix_PlayChannel(0, m.son, 0);
    }
    ...
    else if (y == 3) //multijoueur
    {
      ...
      SDL_BlitSurface(m.imgnewgame, NULL, m.ecran, &m.posnewgame);
      SDL_BlitSurface(m.imgloadgame, NULL, m.ecran, &m.posloadgame);
      SDL_BlitSurface(m.imgmultijoueur2, NULL, m.ecran, &m.posmultijoueur);
      Mix_PlayChannel(0, m.son, 0);
    }
 }
